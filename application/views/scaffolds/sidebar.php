...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li><a href="<?php echo base_url()?>service_report/service_report_list"><i class="fa fa-credit-card"></i>Invoice List</a><?php foreach($job_complete as $complete_jobwork){?><?php if( $complete_jobwork->total == 0){?><span class = "notification_no none"></span><?php }else{ ?><span class = "notification_no"><?php echo $complete_jobwork->total; } } ?></span></li>
           <li class = "divider"></li>
            ...
            <li>
             ...
             <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="<?php echo base_url()?>report/generate_report_invoice">Invoice - Job Completed</a></li>
                </ul>
            </li>
