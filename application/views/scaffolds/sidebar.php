        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="<?php echo base_url()?>service_report/service_report_list"><i class="fa fa-fw fa-file"></i>Service Report  List</a><span class = "notification_no"><?php foreach($service_report as $pending_jobwork){ echo $pending_jobwork->total; } ?></span></li>
