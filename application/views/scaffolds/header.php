...
<head>
    ...
    <script>
     ...
     $(".add_button").click(function(e) { //on add input button click
         FieldCount++;
         e.preventDefault();
         $("#customFields").append('<tr id="customFields" class = "targetfields"><input type = "hidden" name = "count[]" value = "' + FieldCount + '" required /><td><input type = "text" name = "sn[]" class="form-input required sn' + FieldCount + ' id = field_' + FieldCount + '" required/><td><textarea name="sub_description[]" id="sub_description' + FieldCount + '" value="" class="form-input sub sub_description' + FieldCount + '" /></textarea></td><td><input type = "text"  name = "quantity[]" class="form-input required quantity" required/></td><td><input type = "text" name = "uom[]"  class="form-input required" required/> </td><td><input type = "text"  name = "unit_price[]" class="form-input required unit_price" required/></td><td><input type = "text"  name = "amount[]" class="form-input required subtotal res" required/></td><td><a href="javascript:void(0);" class="remCF link_button1"><i class="fa fa-trash-o"></i></a></td></tr>');
     });
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                        <i class="fa fa2 fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
                    </a>
