             ...
             <?php echo validation_errors(); ?>
                <div class="panel-heading"><h3>Generate Report -  Rejected Quotation</h3></div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <?php echo form_open_multipart('report/generate_report_reject');?>  
                      ...
                      <table class = "from_to">
                       <tr>
                         <td><span class = "to_from">FROM</span>&nbsp;&nbsp;&nbsp;<strong><?php $new_from = date("d-m-Y", strtotime($date_from));  if($new_from === ''){ echo '-';}else{ echo $new_from;} ?></strong></td>
