    ...
    public function do_add_quotation()
    {
        if ($this->session->userdata('logged_in')) {
            ...
            if ($this->input->post('submit')) {
                $this->quotation_model->add_quotation($company_name, $address, $tel_num, $fax_num, $email, $date_in, $term_payment, $validity_period, $job_description, $sub_description, $sn, $quantity, $uom, $unit_price, $amount, $sub_total, $gst_total, $grand_total, $user_id);
            }
        } else {
            redirect('login', 'refresh');
        }
